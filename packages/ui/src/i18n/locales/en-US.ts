...
const enUS: Record<string, string> = {
  ...
  "login.newApi.description":
    "Enter your NewAPI address and sign in with your account, or paste an access token. ZCode will fetch or create an API key and import the model list automatically.",
  ...
  "login.newApi.providerPlaceholder":
    "OAuth provider name; leave empty to pick on the NewAPI login page",
  "login.newApi.browserTimeout": "Timed out waiting for the sign-in. Please try again.",
  "login.newApi.advancedToggle": "Advanced: paste an access token",
  "login.newApi.manualOnlyHint":
    "Browser sign-in is unavailable in this environment. Paste an access token instead (create one in the NewAPI console).",
  ...
  "login.newApi.accessTokenPlaceholder": "Paste your NewAPI access token",
  "login.newApi.apiFormatLabel": "API format",
  "login.newApi.apiFormat.openai-chat-completions": "OpenAI compatible",
  "login.newApi.apiFormat.anthropic-messages": "Anthropic compatible",
  "login.newApi.continue": "Connect",
  "login.newApi.cancel": "Cancel",
  "login.newApi.emptyBaseUrlError": "Enter the NewAPI base URL.",
  "login.newApi.emptyTokenError": "Enter the NewAPI access token.",
  "login.newApi.saveError": "Failed to connect to NewAPI: {error}",
  ...
  "settings.usage.tab.newApi": "NewAPI",
  "settings.usage.newApi.title": "NewAPI account",
  "settings.usage.newApi.description": "Account and usage from {system}.",
  "settings.usage.newApi.accountName": "Account (ID)",
  "settings.usage.newApi.role": "Role",
  "settings.usage.newApi.role.commonUser": "User",
  "settings.usage.newApi.role.admin": "Admin",
  "settings.usage.newApi.role.root": "Root",
  "settings.usage.newApi.role.unknown": "Unknown",
  "settings.usage.newApi.status": "Status",
  "settings.usage.newApi.status.enabled": "Enabled",
  "settings.usage.newApi.status.disabled": "Disabled",
  "settings.usage.newApi.balance": "Balance",
  "settings.usage.newApi.usedBalance": "Used",
  "settings.usage.newApi.quotaUnits": "{value} quota",
  "settings.usage.newApi.requestCount": "Requests",
  "settings.usage.newApi.requestCountValue": "{value}",
  "settings.usage.newApi.trendTitle": "Last 7 days",
  "settings.usage.newApi.trendEmpty": "No usage in the last 7 days.",
  "settings.usage.newApi.trendCell": "{quota} quota · {count} requests",
  "settings.usage.newApi.loading": "Loading the NewAPI account...",
  "settings.usage.newApi.notConnectedTitle": "NewAPI is not connected",
  "settings.usage.newApi.notConnectedDescription":
    "Connect a NewAPI provider from Model Providers to see the account and usage here.",
  "settings.usage.newApi.loadFailedDescription":
    "The NewAPI account could not be read. Retry, or sign in to NewAPI again if the access token expired.",
