...
const zhCN: Record<string, string> = {
  ...
  "login.newApi.accessTokenPlaceholder": "粘贴 NewAPI 访问令牌",
  "login.newApi.apiFormatLabel": "API 格式",
  "login.newApi.apiFormat.openai-chat-completions": "OpenAI 兼容",
  "login.newApi.apiFormat.anthropic-messages": "Anthropic 兼容",
  "login.newApi.continue": "连接",
  "login.newApi.cancel": "取消",
  "login.newApi.emptyBaseUrlError": "请输入 NewAPI 地址。",
  "login.newApi.emptyTokenError": "请输入 NewAPI 访问令牌。",
  "login.newApi.saveError": "连接 NewAPI 失败：{error}",
  ...
  "settings.usage.newApi.title": "NewAPI 账号",
  "settings.usage.newApi.description": "账号与用量来自 {system}。",
  "settings.usage.newApi.accountName": "账号名（账号 ID）",
  "settings.usage.newApi.role": "角色",
  "settings.usage.newApi.role.commonUser": "普通用户",
  "settings.usage.newApi.role.admin": "管理员",
  "settings.usage.newApi.role.root": "超级管理员",
  "settings.usage.newApi.role.unknown": "未知",
  "settings.usage.newApi.status": "状态",
  "settings.usage.newApi.status.enabled": "已启用",
  "settings.usage.newApi.status.disabled": "已禁用",
  "settings.usage.newApi.balance": "余额",
  "settings.usage.newApi.usedBalance": "已用余额",
  "settings.usage.newApi.quotaUnits": "{value} quota",
  "settings.usage.newApi.requestCount": "请求次数",
  "settings.usage.newApi.requestCountValue": "{value}",
  "settings.usage.newApi.trendTitle": "近 7 天消耗",
  "settings.usage.newApi.trendEmpty": "近 7 天没有用量记录。",
  "settings.usage.newApi.trendCell": "{quota} quota · {count} 次请求",
  "settings.usage.newApi.loading": "正在读取 NewAPI 账号…",
  "settings.usage.newApi.notConnectedTitle": "尚未连接 NewAPI",
  "settings.usage.newApi.notConnectedDescription":
    "在「模型供应商」中连接 NewAPI 后，这里会展示账号与用量。",
  "settings.usage.newApi.loadFailedDescription":
    "无法读取 NewAPI 账号。可重试；若访问令牌已过期，请重新登录 NewAPI。",
  ...
  "composer.usage.subagentsTooltip":
    "本会话子代理累计 {total} tokens（{sessions} 个子代理、{requests} 次模型请求，与主会话合计分开统计）；明细：{breakdown}",
